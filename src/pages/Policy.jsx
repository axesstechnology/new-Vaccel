        ...
        <div className="container mt-5">
          ...
          <div className="row justify-content-center bg-green-1 text-light">
            <div className="col-md-10">
              ...
              <h4 className="gold-text-2">3. Information Collection and Use</h4>
              <p className="secondary-text">
                We collect several different types of information for various
                purposes to provide and improve our Service to you.
              </p>
              <h4 className="gold-text-2">4. Types of Data Collected</h4>
              <p className="secondary-text">
                ...
                0.1. Email address 0.2. First name and last name 0.3. Phone
                number 0.4. Address, Country, State, Province, ZIP/Postal code,
                City 0.5. Cookies and Usage Data We may use your Personal Data
                ...
                communications from us by following the unsubscribe link. Usage
                Data We may also collect information that your browser sends
                whenever you visit our Service or when you access the Service by
                or through any device (“Usage Data”). This Usage Data may
                ...
                and other diagnostic data. When you access Service with a
                device, this Usage Data may include information such as the type
                of device you use, your device unique ID, the IP address of your
                device, your device operating system, the type of Internet
                browser you use, unique device identifiers and other diagnostic
                data. Location Data We may use and store information about your
                location if you give us permission to do so (“Location Data”).
                We use this data to provide features of our Service, and to
                ...
                Service and we hold certain information. Cookies are files with
                ...
                settings. 0.3. Security Cookies: We use Security Cookies for
                security purposes. 0.4. Advertising Cookies: Advertising Cookies
                are used to serve you with advertisements that may be relevant
                to you and your interests. Other Data While using our Service,
                we may also collect the following information: sex, age, date of
                birth, place of birth, passport details, citizenship,
                registration at the place of residence and actual address,
                telephone number (work, mobile), details of documents on
              ...
              <p className="secondary-text">
                ...
                when you provide the information; 0.13. for any other purpose
                with your consent.
              </p>
              <h4 className="gold-text-2">6. Retention of Data</h4>
              <p className="secondary-text">
              ...
              <h4 className="gold-text-2">7. Transfer of Data</h4>
              <p className="secondary-text">
                Your information, including Personal Data, may be transferred to
                – and maintained on – computers located outside of your state,
                province, country, or other governmental jurisdiction where the
                data protection laws may differ from those of your jurisdiction.
                If you are located outside No. 265, 2nd Floor, GST Road,
                Chromepet, Chennai – 600044 and choose to provide information to
              ...
              <h4 className="gold-text-2">8. Disclosure of Data</h4>
              <p className="secondary-text">
                ...
                sale, your Personal Data may be transferred. 0.3. Other cases.
                We may disclose your information also: 0.3.1. to our
                subsidiaries and affiliates; 0.3.2. to contractors, service
                providers, and other third parties we use to support our
                business; 0.3.3. to fulfill the purpose for which you provide
                it; 0.3.4. for the purpose of including your company’s logo on
                our website; 0.3.5. for any other purpose disclosed by us when
                you provide the information; 0.3.6. with your consent in any
                other cases; 0.3.7. if we believe disclosure is necessary or
                appropriate to protect the rights, property, or safety of the
                Company, our customers, or others.
              </p>
              <h4 className="gold-text-2">9. Security of Data</h4>
              <p className="secondary-text">
              ...
              <p className="secondary-text">
                ...
                incomplete; 0.3. the right to object. You have the right to
                object to our processing of your Personal Data; 0.4. the right
                of restriction. You have the right to request that we restrict
                the processing of your personal information; 0.5. the right to
                data portability. You have the right to be provided with a copy
                of your Personal Data in a structured, machine-readable, and
                commonly used format; 0.6. the right to withdraw consent. You
                also have the right to withdraw your consent at any time when we
                ...
                able to provide Service without some necessary data. You have
              ...
              <p className="secondary-text">
                ...
                CalOPPA, we agree to the following: 0.1. users can visit our
                site anonymously; 0.2. our Privacy Policy link includes the word
              ...
              <p className="secondary-text">
                ...
                can make certain requests and ask us: 0.1. What personal
                information do we have about you? If you make this request, we
                will return to you: 0.0.1. The categories of personal
                information we have collected about you. 0.0.2. The categories
                of sources from which we collect your personal information.
                0.0.3. The business or commercial purpose for collecting or
                selling your personal information. 0.0.4. The categories of
                third parties with whom we share personal information. 0.0.5.
                The specific pieces of personal information we have collected
                about you. 0.0.6. A list of categories of personal information
                that we have sold, along with the category of any other company
                we sold it to. If we have not sold your personal information, we
                will inform you of that fact. 0.0.7. A list of categories of
                personal information that we have disclosed for a business
                purpose, along with the category of any other company we shared
                it with. Please note, that you are entitled to ask us to provide
                ...
                about you in the previous 12 months. 0.2. To delete your
                personal information. If you make this request, we will delete
                the personal information we hold about you as of the date of
                your request from our records and direct any service providers
                to do the same. In some cases, deletion may be accomplished
                through de-identification of the information. If you choose to
                delete your personal information, you may not be able to use
                certain functions that require your personal information to
                operate. 0.3. To stop selling your personal information. We
                don’t sell or rent your personal information to any third
                parties for any purpose. We do not sell your personal
                information for monetary consideration. However, under some
                ...
                disclosure or deletion at any time. If you submit a request to
                stop selling your personal information, we will stop making such
                transfers. Please note, that if you ask us to delete or stop
                selling your data, it may impact your experience with us, and
              ...
              <h4 className="gold-text-2">13. Service Providers</h4>
              <p className="secondary-text">
                ...
                analyzing how our Service is used. These third parties have
              ...
              <h4 className="gold-text-2">14. Analytics</h4>
              <p className="secondary-text">
              ...
              <h4 className="gold-text-2">18. Links to Other Sites</h4>
              <p className="secondary-text">
              ...
              <h4 className="gold-text-2">19. Children’s Privacy</h4>
              <p className="secondary-text">
              ...
              <h4 className="gold-text-2">20. Changes to This Privacy Policy</h4>
              <p className="secondary-text">
